defmodule ArmchairMetropolist.Domain.Entities.SimulationMetrics do
  ...
  @type t :: %__MODULE__{
          ...
          tourism_unlock_residential_count: pos_integer(),
          tourism_residential_count: non_neg_integer(),
          tourists: float(),
          tourist_traffic: float(),
          tourist_revenue: float(),
          attraction_capacity: float(),
          lodging_capacity: float(),
          amenity: float(),
  ...
  @default_derived %{
    ...
    tourism_unlock_residential_count: @tourism_unlock_residential_count,
  ...
  def build(city_map, resources, derived \\ @default_derived) do
    ...
    %__MODULE__{
      ...
      tourism_unlocked: Map.fetch!(derived, :tourism_unlocked),
      tourism_unlock_residential_count: Map.fetch!(derived, :tourism_unlock_residential_count),
      tourism_residential_count: Map.fetch!(derived, :tourism_residential_count),
      tourists: Map.fetch!(derived, :tourists),
      tourist_traffic: Map.fetch!(derived, :tourist_traffic),
      tourist_revenue: Map.fetch!(derived, :tourist_revenue),
      attraction_capacity: Map.fetch!(derived, :attraction_capacity),
      lodging_capacity: Map.fetch!(derived, :lodging_capacity),
