defmodule ArmchairMetropolistWeb do
  @moduledoc """
  ...
  defp html_helpers do
    quote do
      ...
      import Phoenix.HTML
      # Core UI components
      import ArmchairMetropolistWeb.CoreComponents

      # Common modules used in templates
      alias Phoenix.LiveView.JS
      alias ArmchairMetropolistWeb.Layouts
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: ArmchairMetropolistWeb.Router,
        statics: ArmchairMetropolistWeb.static_paths()
    end
  end
